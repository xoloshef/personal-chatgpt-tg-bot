...
⚠️ Для работы с API OpenAI ChatGPT необходим депозит 5$ в лк OpenAI Platform (см пункт 1.2 Получите API ключ от ChatGPT)

Этот проект основан на репозитории: https://github.com/n3d1117/chatgpt-telegram-bot
## Возможности
...
### Отчет использования
- Подсчёт токенов и секунд транскрибации
- Пользовательские бюджет ()
- Логи использования сохраняются в `usage_logs/`э
- Команда (`/stats`)
...
### 2 Установка зависимостей - Старт - Запуск
